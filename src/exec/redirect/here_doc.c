...
/*   Updated: 2025/02/28 20:23:04 by rbardet-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// here_doc loop that play until the LIMITER is typed in the terminal
void	here_doc(t_shell *shell, int i, char *file)
{
	t_doc	*doc;
	int		fd;
...
int	handle_doc(t_shell *shell, int i, int doc_count)
{
	pid_t	pid;
	char	*file;
	char	*tmp2;
